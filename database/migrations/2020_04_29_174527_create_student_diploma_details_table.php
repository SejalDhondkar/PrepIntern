...
class CreateStudentDiplomaDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_diploma_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('student_diploma_details');
    }
}
