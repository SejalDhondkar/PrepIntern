...
class CreateStudentPostGraduationDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('student_post_graduation_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('student_post_graduation_details');
    }
}
