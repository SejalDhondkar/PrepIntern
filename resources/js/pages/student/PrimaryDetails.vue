    ...
    <v-form>
      <v-container class="py-0">
        <v-row>
          ...
          <v-col cols="4" class="text-center" v-if="(student.country_id =='101' && student.state_id !='24') && (student.country_id =='101' && student.state_id !='25') && (student.country_id =='101' && student.state_id !='28') ">
